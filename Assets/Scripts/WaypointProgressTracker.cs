...
namespace UnityStandardAssets.Utility
{
    public class WaypointProgressTracker : MonoBehaviour
    {
        ...
        public void Reset()
        {
            ...
            {
                target.position = circuit.Waypoints[progressNum].gameObject.transform.position;
                target.rotation = circuit.Waypoints[progressNum].gameObject.transform.rotation;
            }
        }
